...
//    sql("LOAD DATA fact from './src/test/resources/data.csv' INTO CUBE stringtypecube PARTITIONDATA(DELIMITER ',', QUOTECHAR '\"')");
    ...
    sql("LOAD DATA fact from 'D:/dummy/Carbondata/integration/spark/src/test/resources/FACT_UNITED_DATA_INFO_sample_cube.csv' INTO CUBE traffic_2g_3g_4g PARTITIONDATA(DELIMITER ',', QUOTECHAR '\"', FILEHEADER '')");
