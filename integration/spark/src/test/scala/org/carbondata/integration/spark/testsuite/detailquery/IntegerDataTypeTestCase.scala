...
class IntegerDataTypeTestCase extends QueryTest with BeforeAndAfterAll {
  ...
  sql("CREATE CUBE cube_restructure444 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1061
test("TC_1061") {
sql("CREATE CUBE cube3 DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube3")
}

//TC_1062
test("TC_1062") {
sql("CREATE CUBE myschema.cube4 DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube4")
}

//TC_1063
test("TC_1063") {
sql("CREATE CUBE cube5 DIMENSIONS (AMSize STRING as col1) MEASURES (Latest_Day INTEGER as col2) OPTIONS (AGGREGATION [col2 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1) ,PARTITION_COUNT=1] )")
sql("drop cube cube5")
}

//TC_1064
test("TC_1064") {
sql("CREATE CUBE myschema.cube6 DIMENSIONS (AMSize STRING as col1) MEASURES (Latest_Day INTEGER as col2) OPTIONS (AGGREGATION [col2 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1) ,PARTITION_COUNT=1] )")
...
//TC_1069
test("TC_1069") {
sql("CREATE CUBE cube27 DIMENSIONS (AMSize STRING) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube27")
}

//TC_1070
test("TC_1070") {
sql("CREATE CUBE myschema.cube28 DIMENSIONS (AMSize STRING) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube28")
}

//TC_1071
test("TC_1071") {
sql("CREATE CUBE myschema.cube29 DIMENSIONS (AMSize STRING as col1) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube29")
}

//TC_1072
test("TC_1072") {
sql("CREATE CUBE cube30 DIMENSIONS (AMSize STRING as col1) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube31 MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (Latest_Day), PARTITION_COUNT=1] )")
}
catch
{
  case ex: Throwable => 
...
try
{
sql("CREATE CUBE cube32 MEASURES (Latest_Day INTEGER as col2) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col2), PARTITION_COUNT=1] )")
}
catch
{
  case ex: Throwable => 
...
//TC_1076
test("TC_1076") {
sql("CREATE CUBE cube34 DIMENSIONS (AMSize STRING,deviceInformationId STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize,deviceInformationId) ,PARTITION_COUNT=1] )")
sql("drop cube cube34")
}

//TC_1077
test("TC_1077") {
sql("CREATE CUBE myschema.cube35 DIMENSIONS (AMSize STRING,deviceInformationId STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize,deviceInformationId) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube35")
}

//TC_1078
test("TC_1078") {
sql("CREATE CUBE cube36 DIMENSIONS (AMSize STRING as col1,deviceInformationId STRING as col2) MEASURES (Latest_Day INTEGER as col3) OPTIONS (AGGREGATION [col3 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1,col2) ,PARTITION_COUNT=1] )")
sql("drop cube cube36")
}

//TC_1079
test("TC_1079") {
sql("CREATE CUBE myschema.cube37 DIMENSIONS (AMSize STRING as col1,deviceInformationId STRING as col2) MEASURES (Latest_Day INTEGER as col3) OPTIONS (AGGREGATION [col3 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1,col2) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube37")
}

//TC_1080
test("TC_1080") {
sql("CREATE CUBE myschema.cube38 DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl',COLUMNS= (AMSize) ,PARTITION_COUNT=10] )")
sql("drop cube myschema.cube38")
}

//TC_1081
test("TC_1081") {
sql("CREATE CUBE cube39 DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl',COLUMNS= (AMSize) ,PARTITION_COUNT=10] )")
...
//TC_1098
test("TC_1098") {
sql("CREATE CUBE cube106 DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = sum] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube106")
}

//TC_1099
test("TC_1099") {
sql("CREATE CUBE cube107 DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = avg] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube107")
}

//TC_1100
test("TC_1100") {
sql("CREATE CUBE cube108 DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = min] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube108")
}

//TC_1101
test("TC_1101") {
sql("CREATE CUBE cube109 DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = max] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
...
//TC_1110
test("TC_1110") {
sql("create cube cube118 dimensions (AMSize STRING) measures (Latest_Day INTEGER) options (aggregation [Latest_Day = count] partitioner [class = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', columns= (AMSize) ,partition_count=1] )")
...
test("TC_1111") {
  ...
  try
  {
    sql("create cube cube119 dimensions () measures () options (aggregation [] partitioner [class = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', columns= () ,partition_count=1] )")
...
sql("CREATE CUBE cube_restructure1 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1116
test("TC_1116") {
sql("CREATE CUBE cube3_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube3_drop")
}

//TC_1117
test("TC_1117") {
sql("CREATE CUBE myschema.cube4_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube4_drop")
}

//TC_1118
test("TC_1118") {
sql("CREATE CUBE cube5_drop DIMENSIONS (AMSize STRING as col1) MEASURES (Latest_Day INTEGER as col2) OPTIONS (AGGREGATION [col2 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1) ,PARTITION_COUNT=1] )")
sql("drop cube cube5_drop")
}

//TC_1119
test("TC_1119") {
sql("CREATE CUBE myschema.cube6_drop DIMENSIONS (AMSize STRING as col1) MEASURES (Latest_Day INTEGER as col2) OPTIONS (AGGREGATION [col2 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1) ,PARTITION_COUNT=1] )")
...
//TC_1124
test("TC_1124") {
sql("CREATE CUBE cube27_drop DIMENSIONS (AMSize STRING) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube27_drop")
}

//TC_1125
test("TC_1125") {
sql("CREATE CUBE myschema.cube28_drop DIMENSIONS (AMSize STRING) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube28_drop")
}

//TC_1126
test("TC_1126") {
sql("CREATE CUBE myschema.cube29_drop DIMENSIONS (AMSize STRING as col1) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube29_drop")
}

//TC_1127
test("TC_1127") {
sql("CREATE CUBE cube30_drop DIMENSIONS (AMSize STRING as col1) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1) ,PARTITION_COUNT=1] )")
...
//TC_1129
test("TC_1129") {
sql("CREATE CUBE cube34_drop DIMENSIONS (AMSize STRING,deviceInformationId STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize,deviceInformationId) ,PARTITION_COUNT=1] )")
sql("drop cube cube34_drop")
}

//TC_1130
test("TC_1130") {
sql("CREATE CUBE myschema.cube35_drop DIMENSIONS (AMSize STRING,deviceInformationId STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize,deviceInformationId) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube35_drop")
}

//TC_1131
test("TC_1131") {
sql("CREATE CUBE cube36_drop DIMENSIONS (AMSize STRING as col1,deviceInformationId STRING as col2) MEASURES (Latest_Day INTEGER as col3) OPTIONS (AGGREGATION [col3 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1,col2) ,PARTITION_COUNT=1] )")
sql("drop cube cube36_drop")
}

//TC_1132
test("TC_1132") {
sql("CREATE CUBE myschema.cube37_drop DIMENSIONS (AMSize STRING as col1,deviceInformationId STRING as col2) MEASURES (Latest_Day INTEGER as col3) OPTIONS (AGGREGATION [col3 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (col1,col2) ,PARTITION_COUNT=1] )")
sql("drop cube myschema.cube37_drop")
}

//TC_1133
test("TC_1133") {
sql("CREATE CUBE myschema.cube38_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl',COLUMNS= (AMSize) ,PARTITION_COUNT=10] )")
sql("drop cube myschema.cube38_drop")
}

//TC_1134
test("TC_1134") {
sql("CREATE CUBE cube39_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl',COLUMNS= (AMSize) ,PARTITION_COUNT=10] )")
...
//TC_1143
test("TC_1143") {
sql("CREATE CUBE cube106_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = sum] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube106_drop")
}

//TC_1144
test("TC_1144") {
sql("CREATE CUBE cube107_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = avg] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube107_drop")
}

//TC_1145
test("TC_1145") {
sql("CREATE CUBE cube108_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = min] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube108_drop")
}

//TC_1146
test("TC_1146") {
sql("CREATE CUBE cube109_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = max] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube109_drop")
}

//TC_1147
test("TC_1147") {
sql("CREATE CUBE cube110_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = max] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
sql("drop cube cube110_drop")
}

//TC_1148
test("TC_1148") {
sql("CREATE CUBE cube111_drop DIMENSIONS (AMSize STRING) MEASURES (Latest_Day INTEGER) OPTIONS (AGGREGATION [Latest_Day = max] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
...
//TC_1151
test("TC_1151") {
sql("create cube cube118_drop dimensions (AMSize STRING) measures (Latest_Day INTEGER) options (aggregation [Latest_Day = count] partitioner [class = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', columns= (AMSize) ,partition_count=1] )")
...
//TC_1154
test("TC_1154") {
sql("create cube cube119_drop dimensions (AMSize STRING) measures (Latest_Day INTEGER) options (aggregation [Latest_Day = count] partitioner [class = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', columns= (AMSize) ,partition_count=1] )")
...
sql("CREATE CUBE cube_restructure61 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1170
test("TC_1170") {
sql("create cube vardhan200 dimensions(imei string,AMSize string,channelsId string,ActiveCountry string, Activecity string)  measures(gamePointId numeric,deviceInformationId integer) OPTIONS (PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl' columns= (imei,AMSize) PARTITION_COUNT=2] )")
...
sql("CREATE CUBE cube_restructure DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE incloading_DTS2015112006803_01 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure60 DIMENSIONS (AMSize STRING) MEASURES (Latest_DAY INTEGER) OPTIONS (AGGREGATION [Latest_DAY = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE incloading1 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure68 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE testwithout_measure DIMENSIONS (AMSize STRING) OPTIONS (AGGREGATION [Latest_Day = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (AMSize) ,PARTITION_COUNT=1] )")
...
//TC_1197
test("TC_1197") {
sql("CREATE CUBE cube_restructure2 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1198
test("TC_1198") {
sql("CREATE CUBE cube_restructure3 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1200
test("TC_1200") {
sql("CREATE CUBE cube_restructure5 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1204
test("TC_1204") {
sql("CREATE CUBE cube_restructure9 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1205
test("TC_1205") {
sql("CREATE CUBE cube_restructure10 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1206
test("TC_1206") {
sql("CREATE CUBE cube_restructure11 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1207
test("TC_1207") {
sql("CREATE CUBE cube_restructure12 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1208
test("TC_1208") {
sql("CREATE CUBE cube_restructure13 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1209
test("TC_1209") {
sql("CREATE CUBE cube_restructure14 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1210
test("TC_1210") {
sql("CREATE CUBE cube_restructure15 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1211
test("TC_1211") {
sql("CREATE CUBE cube_restructure16 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1212
test("TC_1212") {
sql("CREATE CUBE cube_restructure17 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1213
test("TC_1213") {
sql("CREATE CUBE cube_restructure18 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1214
test("TC_1214") {
sql("CREATE CUBE cube_restructure19 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1217
test("TC_1217") {
sql("CREATE CUBE cube_restructure22 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1218
test("TC_1218") {
sql("CREATE CUBE cube_restructure23 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1219
test("TC_1219") {
sql("CREATE CUBE cube_restructure24 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1220
test("TC_1220") {
sql("CREATE CUBE cube_restructure25 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE res.cube_restructure27 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1224
test("TC_1224") {
sql("CREATE CUBE res.cube_restructure29 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1225
test("TC_1225") {
sql("CREATE CUBE cube_restructure_alias30 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1226
test("TC_1226") {
sql("CREATE CUBE cube_restructure_alias31 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1227
test("TC_1227") {
sql("CREATE CUBE cube_restructure_alias32 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1228
test("TC_1228") {
sql("CREATE CUBE cube_restructure_alias33 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1229
test("TC_1229") {
sql("CREATE CUBE cube_restructure_alias34 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1230
test("TC_1230") {
sql("CREATE CUBE cube_restructure_alias35 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1231
test("TC_1231") {
sql("CREATE CUBE cube_restructure_alias36 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1232
test("TC_1232") {
sql("CREATE CUBE cube_restructure_alias37 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1233
test("TC_1233") {
sql("CREATE CUBE cube_restructure_alias38 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1234
test("TC_1234") {
sql("CREATE CUBE cube_restructure_alias39 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
//TC_1235
test("TC_1235") {
sql("CREATE CUBE cube_restructure40 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1236
test("TC_1236") {
sql("CREATE CUBE cube_restructure41 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1237
test("TC_1237") {
sql("CREATE CUBE cube_restructure42 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1238
test("TC_1238") {
sql("CREATE CUBE cube_restructure43 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1239
test("TC_1239") {
sql("CREATE CUBE cube_restructure44 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1240
test("TC_1240") {
sql("CREATE CUBE cube_restructure45 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1241
test("TC_1241") {
sql("CREATE CUBE cube_restructure46 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
//TC_1243
test("TC_1243") {
sql("CREATE CUBE cube_restructure48 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure55 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure56 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure57 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure58 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure59 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure63 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("CREATE CUBE cube_restructure64 DIMENSIONS (a0 STRING as alias1) MEASURES (b0 INTEGER as alias2) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (alias1) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure4 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure6 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure7 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure8 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure20 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure21 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure26 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure47 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure49 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure50 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure51 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure52 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure53 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure54 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("create cube test1.t5 dimensions(imei string, productdate timestamp,updatetime timestamp) measures(gamePointId numeric,contractNumber numeric) OPTIONS (PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl' ,columns= (imei) ,PARTITION_COUNT=2] )")
sql("create cube t5 dimensions(imei string, productdate timestamp,updatetime timestamp) measures(gamePointId numeric,contractNumber numeric) OPTIONS (PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl' ,columns= (imei) ,PARTITION_COUNT=2] )\"")
...
{
sql("CREATE schema IF NOT EXISTS test1")
sql("create cube test1.t6 dimensions(imei string, productdate timestamp,updatetime timestamp) measures(gamePointId numeric,contractNumber numeric) OPTIONS (PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl' ,columns= (imei) ,PARTITION_COUNT=2] )")
...
sql("create cube t6 dimensions(imei string, productdate timestamp,updatetime timestamp) measures(gamePointId numeric,contractNumber numeric) OPTIONS (PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl' ,columns= (imei) ,PARTITION_COUNT=2] )")
...
sql("create cube cube22 dimensions(imei string, productdate timestamp) measures(gamePointId numeric,contractNumber numeric) OPTIONS (PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl' ,columns= (imei) ,PARTITION_COUNT=2] )")
...
sql("create CUBE cube_restructure60 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("create CUBE cube_restructure62 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("create CUBE cube_restructure64 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
try
{
sql("CREATE CUBE cube_restructure65 DIMENSIONS (a0 STRING) MEASURES (b0 INTEGER) OPTIONS (AGGREGATION [b0 = count] PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (a0) ,PARTITION_COUNT=1] )")
...
sql("SHOW CREATE CUBE t22 FACT FROM test1 INCLUDE (deviceInformationId), DIMENSION FROM table4:test1 RELATION (FACT.imei = imei) EXCLUDE (mac,deviceInformationId) OPTIONS (PARTITIONER [CLASS = 'com.huawei.datasight.molap.partition.api.impl.SampleDataPartitionerImpl', COLUMNS= (imei), PARTITION_COUNT=5] )")
